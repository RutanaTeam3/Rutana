...
if text == (database:get(bot_id.."OliveR:Name:Bot") or "اوليفير") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."OliveR:Name:Bot") or "اوليفير")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/SourceOliveR/OliveR/master/OliveR.lua')
os.execute('wget https://raw.githubusercontent.com/SourceOliveR/OliveR/master/start.lua')
dofile('OliveR.lua')  
return false
end
if text == "راسلني" then
...
if DevOliveR(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceOliveR/files_OliveR/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/OliveR/files_OliveR/master/files_OliveR/"..file)
if res == 200 then
...
local Name_Bot = (database:get(bot_id.."OliveR:Name:Bot") or "اوليفير")
